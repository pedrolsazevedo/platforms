...
target "node" {
  ...
  args = {
    BASE_IMAGE = "node:alpine@sha256:dbaa92e5758cbbcf85d65d5403fdb530fe3442cbe8c6dbfb7ef23365450d5070"
  }
}
...
target "oraclelinux" {
  ...
  args = {
    BASE_IMAGE = "oraclelinux:10@sha256:2f145af52abf6ee5be815b35751c65dc1531a4c709904c4fd7f72b23fdbc5015"
  }
}
